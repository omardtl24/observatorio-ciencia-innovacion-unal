...
class DocumentPresentationCreateRequest(BaseModel):
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={
            "example": {
                "main_title": "Presentacion institucional",
                "auxiliary_title": "Resultados 2025",
    ...
    main_title: str = Field(..., min_length=1, description="The main title of the document presentation")
    auxiliary_title: Optional[str] = Field(None, description="The auxiliary title of the document presentation")
...
class DocumentPresentationUpdateRequest(BaseModel):
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={
            "example": {
                "main_title": "Presentacion actualizada",
    ...
    main_title: Optional[str] = Field(None, min_length=1, description="The main title of the document presentation")
    auxiliary_title: Optional[str] = Field(None, description="The auxiliary title of the document presentation")
    description: Optional[str] = Field(None, description="The description of the document presentation")
    file_id: Optional[int] = Field(None, description="The ID of the associated file")
