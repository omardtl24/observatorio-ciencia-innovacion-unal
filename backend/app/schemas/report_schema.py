...
class ReportCreateRequest(BaseModel):
    ...
    Attributes:
        ...
        updated_at: The last update date of the report (required).
    """
    ...
    updated_at: date = Field(..., description="The last update date of the report")
...
class ReportUpdateRequest(BaseModel):
    ...
    Attributes:
        ...
        description: The description of the report (optional).
        document_file_id: The ID of the associated file (optional).
        updated_at: The last update date of the report (optional).
    """
    model_config = ConfigDict(
        extra='forbid',
        validate_default=True,
    ...
    description: Optional[str] = Field(None, description="The description of the report")
    document_file_id: Optional[int] = Field(None, description="The ID of the associated document file")
    updated_at: Optional[date] = Field(None, description="The last update date of the report")
