...
import { hasAdministratorRole } from "./dashboardUtils";
...
export default function CreateResource() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await createResource(currentDefinition.endpoint, payload);
      navigate("/dashboard");
    } catch (error) {
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-md p-8 lg:sticky lg:top-8">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-4 text-primary-blue-strong">
                {parseRichText(previewDescriptionEncoded, "text-primary-cyan-base")}
              </div>
            </div>
          </div>
        </div>
